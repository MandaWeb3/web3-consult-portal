...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, description, icon, index }) => {
  return (
    <Reveal delay={index * 100}>
      <div className="group relative p-8 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-xl bg-white border border-gray-100">
    ...
    <section id="services" className="py-20 md:py-32 bg-gradient-to-b from-white/50 to-background">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 text-center">
          <Reveal>
            <div className="p-8 rounded-xl bg-web3-accent/5 border border-web3-accent/20 max-w-3xl mx-auto">
              <h3 className="text-2xl font-bold mb-4">Need a custom solution?</h3>
              <p className="text-foreground/80 mb-6">
                I offer tailored consulting services designed specifically for your business needs.
              </p>
